...
class MainActivity : Activity() {
    ...
    //TODO Feature  : Implement the push data mechanism so the entries deleted by the user are also marked as deleted in the server.
    ...
    //TODO Feature  : Implement a progress bar dialog that appears while the user is waiting for login authentication.
    ...
    //TODO Bug***   : In the search dialog the user has no way to return to the current day. Arrow buttons must be implemented.
    //TODO Bug***   : After using search the arrow buttons that change date disappear. They also disappear for certain long dates.
